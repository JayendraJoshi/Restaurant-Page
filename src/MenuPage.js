...
const menuPage = function () {
  ...
  daalDescription.textContent =
    "Slow-cooked lentils tempered with garlic, cumin, and aromatic spices";
  ...
  chapatiDescription.textContent =
    "Soft, whole wheat flatbread with chutney and pickles";
  ...
  paneerDescription.textContent =
    "Deliciously fresh Indian cottage cheese simmered in a rich and creamy tomato butter gravy";
  ...
  samosaDescription.textContent =
    "Crispy pastry stuffed with spiced potatoes and peas, served with chutneys";
  ...
  dosaDescription.textContent =
    "Thin, crispy fermented rice and lentil dosa filled with a spiced potato mash, served with sambar and chutneys";
  ...
  chickenTikkaDescription.textContent =
    "Tandoor-grilled chicken simmered in a creamy tomato and spice-infused sauce";
